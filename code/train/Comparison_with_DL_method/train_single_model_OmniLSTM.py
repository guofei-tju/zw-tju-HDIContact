...
model_type = "TurnBiLSTM32_1"#"Conv_layer5"#"Conv_layer3" TurnBiLSTM
stop_stype = "acc"#Loss
hidden_size=32
hidden_size2 = 32
num_layer=1
...
python_add = "F:/Paper2Code/esm-MSA/esm-master/esm/final_figuretableData/train/Comparison_with_DL_method/train_single_model_OmniLSTM"
for i in range(2,8):
    os.system("E:\Anaconda3\envs\py37\python.exe "+python_add+str(i)+".py")